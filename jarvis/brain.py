...
class Brain:
    ...
    async def think(self, problem, context):
        ...
        await self.log_thoughts(problem, solution)
    ...
    async def _update_long_term_memory(self, problem, solution):
        ...
        await self.jarvis.memory.remember(memory_key, record, category="reasoning")
    ...
    async def log_thoughts(self, task: str, result: dict[str, Any]) -> None:
        """Persist reasoning outcome for later introspection."""
        await self._update_long_term_memory(task, result)
